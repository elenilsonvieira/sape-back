...
public class PlaceDTO {
	...
	private String nameResponsiblePlace;
	
	public PlaceDTO() {
		
	}
	
	public PlaceDTO(String name, String reference, int maximumCapacityParticipants, boolean isPublic, String nameResponsiblePlace) {
		this.name = name;
	...
	public PlaceDTO(Integer id, String name, String reference, int maximumCapacityParticipants, boolean isPublic, String nameResponsiblePlace) {
		this.id = id;
		this.name = name;
		this.reference = reference;
		this.maximumCapacityParticipants = maximumCapacityParticipants;
		this.isPublic = isPublic;
		this.nameResponsiblePlace = nameResponsiblePlace;
	}
	...
	public String getNameResponsiblePlace() {
		return nameResponsiblePlace;
	}

	public void setNameResponsiblePlace(String nameResponsiblePlace) {
		this.nameResponsiblePlace = nameResponsiblePlace;
	}
