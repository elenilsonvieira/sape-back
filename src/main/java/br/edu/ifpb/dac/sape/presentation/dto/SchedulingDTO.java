...
public class SchedulingDTO {
	...
	public SchedulingDTO(Integer id, String scheduledDate, String scheduledStartTime, String scheduledFinishTime, LocalTime startTime,  
			Integer placeId, Integer sportId, StatusScheduling status) {
		this.id = id;
	...
	@Override
	public int hashCode() {
		return Objects.hash(id, placeId, scheduledDate, scheduledFinishTime, scheduledStartTime, sportId, status);
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(id, other.id) && Objects.equals(placeId, other.placeId)
				...
				&& Objects.equals(sportId, other.sportId) && status == other.status;
	}
