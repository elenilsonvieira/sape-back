...
public class Scheduling implements Serializable {
	...
	public Scheduling(LocalDate scheduledDate, LocalTime scheduledStartTime, LocalTime scheduledFinishTime, Place place, Sport sport, StatusScheduling status) {
	...
	@Override
	public int hashCode() {
		return Objects.hash(creator, id, participants, place, scheduledDate, scheduledFinishTime, scheduledStartTime,
				sport, status);
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(creator, other.creator) && Objects.equals(id, other.id)
				&& Objects.equals(participants, other.participants) && Objects.equals(place, other.place)
				&& Objects.equals(scheduledDate, other.scheduledDate)
				&& Objects.equals(scheduledFinishTime, other.scheduledFinishTime)
				&& Objects.equals(scheduledStartTime, other.scheduledStartTime) && Objects.equals(sport, other.sport)
				&& status == other.status;
	}
