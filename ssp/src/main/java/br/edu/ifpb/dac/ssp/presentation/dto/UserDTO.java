...
public class UserDTO {
	...
	public UserDTO(String name, String email, Long registration,String sports) {
		this.name = name;
		this.email = email;
		this.registration = registration;
		this.sportsFavorite = sports;
	}
	
	public UserDTO(Integer id, String name, String email, Long registration,String sports) {
		this.id = id;
		this.name = name;
		this.email = email;
		this.registration = registration;
